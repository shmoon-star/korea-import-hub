...
- [ ] All-in-One 솔루션 업체 시장 조사 (한국·글로벌 vendor 리스트업)
- [ ] RFI/RFP — 위 5가지 선정 기준 기반 평가
- [ ] E2E와의 파트너십 = **포워더 역할로 한정**임을 명문화 (계약/MoU)
- [ ] 자체 hub의 어그리게이터 기능 강화 — 각 채널 ETL/품질 관리 자동화 (사람 손 보정 부담 흡수)
